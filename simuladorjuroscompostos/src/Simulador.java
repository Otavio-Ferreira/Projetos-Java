...
public class Simulador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SIMULADOR JUROS SIMPLES");
        ...
        jLabel2.setText("CAPITAL  R$");

        jLabel3.setText("TAXA DE JUROS  %");

        jLabel4.setText("TEMPO N°");

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("SELECIONE O TIPO DE TAXA E TEMPO");
        jLabel5.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("A.A");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("A.M");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        float capital, tempo, rentabilidade, montante;
        double juros, juros1;
        capital = Float.parseFloat(jTextField1.getText());
        tempo = Float.parseFloat(jTextField2.getText());
        juros = Double.parseDouble(jTextField3.getText());
        juros1 = juros/100;
        
        if(jRadioButton1.isSelected()){
            rentabilidade = (float) (capital * juros1 * tempo);
            montante = rentabilidade + capital;
            jTextField4.setText(Float.toString(rentabilidade));
            jTextField5.setText(Float.toString(montante));
            
        }
        else{
            rentabilidade = (float) (capital * juros1 * tempo);
            montante = rentabilidade + capital;
            jTextField6.setText(Float.toString(rentabilidade));
            jTextField5.setText(Float.toString(montante));
        }
